...
const ARTICLE_JSONLD = {
  ...
  url: "https://mlfs.online/chapters/11-playground/",
  mainEntityOfPage: "https://mlfs.online/chapters/11-playground/",
  isPartOf: { "@type": "Book", name: "Machine Learning From Scratch", url: "https://mlfs.online/" },
  inLanguage: "en",
  image: "https://mlfs.online/chapters/11-playground/opengraph-image",
  ...
  teaches: [
    "Applied machine learning patterns",
  ...
  mentions: ["Sentiment Analysis", "Spotify API", "Mini ML Project", "Python Workflow"],
};
