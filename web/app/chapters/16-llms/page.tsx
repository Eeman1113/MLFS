...
const ARTICLE_JSONLD = {
  ...
  url: "https://mlfs.online/chapters/16-llms/",
  mainEntityOfPage: "https://mlfs.online/chapters/16-llms/",
  isPartOf: { "@type": "Book", name: "Machine Learning From Scratch", url: "https://mlfs.online/" },
  inLanguage: "en",
  image: "https://mlfs.online/chapters/16-llms/opengraph-image",
  ...
  timeRequired: "PT1H",
  wordCount: 3500,
  articleSection: "Bonus",
  learningResourceType: "lesson",
  educationalLevel: "Intermediate",
  isAccessibleForFree: true,
  teaches: [
    "Tokenization and embeddings",
    "Self-attention and Q, K, V matrices",
    "Transformer architecture",
    "Sampling strategies and KV caches",
    "RLHF and chain-of-thought reasoning",
  ],
  keywords: [
    "LLM",
    "large language models",
